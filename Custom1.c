// This is an example to show you how to customize Hohha for your specific needs
// Just copy this two function in place of the original encryptor functions on the main file
// In this example, we just added this line to inner loop: V ^= (uint32_t)(Body[t&BodyMask]);
// You can "harden" the encryption as much as you want by adding more operations to inner loop 
